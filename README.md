The AI-AMA2 app is not important right now It is the remake of an AI chat bot app but for now the repository serves as a host for various data analysis and  crypto trading bots. 
